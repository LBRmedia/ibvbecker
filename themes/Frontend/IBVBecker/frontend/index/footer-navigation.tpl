	        ...
	        {block name="frontend_index_footer_column_service_action_content"}
	            <div class="column--content">
                 <nav class="navigation-icons">
	              <ul>
		              <li class="navigation--icons"><i class="fa fa-check"></i><div class="label_icons"><span class="label_headline">Mindestbestellwert</span><br/>Kein Mindestbestellwert in unserem Shop</div></li>
	                  <li class="navigation--icons"><i class="fa fa-check"></i><div class="label_icons"><span class="label_headline">Versand</span><br/>Wir versenden Ihre Ware zuverlässig und schnell</div></li>
	                  <li class="navigation--icons"><i class="fa fa-check"></i><div class="label_icons"><span class="label_headline">Beratung</span><br/>Qualifiziertes Personal rund um Ihre Fragen</div></li>
	              </ul>
	             </nav>
	           </div>
	        {/block}
			...
			<div class="footer--column column--payment block">
				...
				{block name="frontend_index_footer_column_payment_content"}
					<div class="column--content">
						...
						<img src="{link file='frontend/_public/src/img/zahlungsart/rechnung.jpg'}" width="100" alt="Zahlung per Rechnung">
		...
		{block name="frontend_index_footer_column_shipping"}
			<div class="footer--column column--shipping block">
				...
				{block name="frontend_index_footer_column_shipping_content"}
					<div class="column--content">
						<img src="{link file='frontend/_public/src/img/versand/gls.jpg'}" width="100" alt="DPD">
						<img src="{link file='frontend/_public/src/img/versand/dhlexpress.jpg'}" width="100" alt="DPD">
						<img src="{link file='frontend/_public/src/img/versand/spedition.jpg'}" width="100" alt="DPD">
					</div>
				{/block}
			</div>
		{/block}
